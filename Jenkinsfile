...
Integer findCommentIdByUser(String credential, String repository, String pr_number, String username, String expression = '') {
	...
	String api_endpoint = "https://github.com/repos/${repository}/issues/${pr_number}/comments"
...
void postGHPRComment(String credential, String repository, String pr_number, String message, Integer comment_id = 0) {
	...
	String api_endpoint = "https://github.com/repos/${repository}/issues"
    if(comment_id) {
...
int id = findCommentIdByUser('gittoken', ' Dileep1314/new-gradle ', '6', 'samrocketman', pattern)
postGHPRComment('gittoken', ' Dileep1314/new-gradle ', '6', message, id)
